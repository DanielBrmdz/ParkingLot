...
public class ParkingLot {
    ...
    public Product getProductTub(String name) {
        int posProd = tubers.indexOf(name);
        return tubers.get(posProd);
    }

    public Product getProductVeg(String name) {
        int posProd = vegetables.indexOf(name);
        return vegetables.get(posProd);
    }

    public Product getProductFru(String name) {
        int posProd = fruits.indexOf(name);
        return fruits.get(posProd);
    }
